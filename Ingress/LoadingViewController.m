...
- (void)viewDidLoad {
	...
	[activationButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:18]];
	...
	[createCodenameButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance]  titleLabel] font] fontName] size:18]];
				...
				if (!errorStr) {
					...
					if ([errorStr isEqualToString:@"USER_REQUIRES_ACTIVATION"]) {
						...
						dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
							...
							termsConfirmButton.titleLabel.font = [UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:28];
						});
...
- (IBAction)createCodename {
	...
	[[API sharedInstance] validateNickname:createCodenameField.text completionHandler:^(NSString *errorStr) {
		...
		if (errorStr) {
			...
			[codenameErrorRetryButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance]  titleLabel] font] fontName] size:22]];
			...
			[codenameConfirmButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:28]];
			[codenameConfirmRetryButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:22]];
