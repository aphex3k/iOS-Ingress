...
- (void)viewDidLoad {
	...
	hackButton.titleLabel.font = [UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:16];
	rechargeButton.titleLabel.font = [UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:16];
	linkButton.titleLabel.font = [UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:16];
