...
- (void)viewDidLoad {
	...
	[groupSegments setTitleTextAttributes:@{UITextAttributeFont: [UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:12]} forState:UIControlStateNormal];
	
	transmitTextField.font = [UIFont fontWithName:[[[UITextField appearance] font] fontName] size:15];
	transmitButton.titleLabel.font = [UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:15];
