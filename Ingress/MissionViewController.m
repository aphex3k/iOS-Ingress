...
- (void)setupFactionChooseIntro {
	...
	[mainButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:28]];
...
- (void)showFactionChooseButtons {
	...
	[joinResistanceButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:22]];
	[joinResistanceButton setTitleColor:[Utilities colorForFaction:@"RESISTANCE"] forState:UIControlStateNormal];

	[joinEnlightenedButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:22]];
...
- (void)setupIntro {
	...
	[altButton.titleLabel setFont:[UIFont fontWithName:[[[[UIButton appearance] titleLabel] font] fontName] size:22]];
